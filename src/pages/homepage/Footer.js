import { faCodepen, faFacebook, faGithub, faInstagramSquare, faLinkedin, faTwitter } from '@fortawesome/free-brands-svg-icons';
...
const Footer = () => {
    return (
        <footer className='p-2 p-md-5 text-center'>
            ...
            <p className='secondary-color-text'>All right reserved &copy; <cite>Naimur Rahman</cite> - {new Date().getFullYear()}</p>
        </footer>
    );
};
